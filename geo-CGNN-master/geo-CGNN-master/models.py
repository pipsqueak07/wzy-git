...
class geo_CGNN(nn.Module):
    def __init__(self, n_node_feat, n_hidden_feat, n_GCN_feat, conv_bias, N_block, node_activation, MLP_activation,
                 use_node_batch_norm, use_edge_batch_norm, N_shbf, N_srbf, cutoff, max_nei, n_MLP_LR, n_grid_K,
                 n_Gaussian):
        ...
        self.conv = [
            GatedGraphConvolution(n_node_feat, n2v_concatent_feat, n_hidden_feat, N_shbf, N_srbf, n_grid_K, n_Gaussian,
    ...
    def forward(self, nodes, edge_sources, edge_targets, edge_distance, graph_indices, node_counts, combine_sets,
                plane_wave, output_graph=False):
